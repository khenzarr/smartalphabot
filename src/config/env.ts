...
const schema = z.object({
  ...
  MONITOR_ACTIVITY_PROVIDER: z.enum(['auto', 'rpc-addressless', 'rpc-wallet-activity', 'rpc-known-tokens', 'explorer', 'auto-indexer', 'wallet-activity-first']).default('auto-indexer'),
  ...
  MONITOR_WALLET_ACTIVITY_ENABLED: booleanEnvWithFallback(true),
  MONITOR_WALLET_ACTIVITY_CURSOR_ENABLED: booleanEnvWithFallback(true),
  MONITOR_WALLET_ACTIVITY_LOOKBACK_BLOCKS_ETHEREUM: z.coerce.number().int().positive().default(300),
  MONITOR_WALLET_ACTIVITY_LOOKBACK_BLOCKS_BASE: z.coerce.number().int().positive().default(900),
  MONITOR_WALLET_ACTIVITY_MAX_WALLETS_PER_RUN: z.coerce.number().int().positive().default(25),
  MONITOR_WALLET_ACTIVITY_MAX_TOKENS_PER_RUN: z.coerce.number().int().positive().default(50),
