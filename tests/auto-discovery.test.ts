...
function buildSeedBatchResult(overrides: Partial<SeedBatchRunResult> = {}): SeedBatchRunResult {
  return {
    ...
    summary: {
      ...
      getLogsRequestsUsed: 0,
      requestBudgetReached: false,
      cachedTokenResultsLoaded: 0,
      cachedTokenResultsWritten: 0,
      completedSeedResults: 6,
      pendingSeedResults: 0,
    ...
    const run = vi.fn().mockResolvedValue(
      buildSeedBatchResult({
        summary: {
          ...
          cachedTokenResultsLoaded: 0,
          cachedTokenResultsWritten: 0,
          completedSeedResults: 5,
          pendingSeedResults: 1,
          cumulativeMode: false,
        },
        candidateShortlist: [],
      }),
